...
def attack(char_name: str, char_class: str) -> str:
    """Выводит сообщение о нанесеном уроне в атаке."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} нанёс урон противнику неведомой силы')


def defence(char_name: str, char_class: str) -> str:
    """Выводит сообщение о заблокированных нападениях."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} блокировал неизвестную величину урона')


def special(char_name: str, char_class: str) -> str:
    """Выводит сообщение о применении специальных умений."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не владеет специальными умениями')


def start_training(char_name: str, char_class: str) -> str:
    """Обучение командам игры."""
    if char_class == 'warrior':
